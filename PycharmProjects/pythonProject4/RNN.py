...
class RNN:
    ...
    def LSTM_layer(self, embeddings):
        ...
        #self._mask : [num docs * MAX_SENTCE_LENGTH, ]
        mask =  tf. sequence_mask(
            lengths=self._sentence_lengths,
            maxlen=MAX_SENTENCE_LENGTH,
            dtype=tf.float32
        ) # [num_docs, MAX_SENTENCE_LENGTH]
        mask =  tf.concat(tf.unstack(mask, axis=0), axis=1)
...
def train_and_evaluate_RNN():
  with open('C:/Users/Thuy Duong/PycharmProjects/pythonProject2/datasets/w2v/vocab-raw.txt') as f:
  ...
  with tf.Session() as sess:
    train_data_reader = DataReader(
        data_path='C:/Users/Thuy Duong/PycharmProjects/pythonProject2/datasets/w2v/20news-train-encoded.txt',
        batch_size=50
    )
    test_data_reader = DataReader(
        data_path='C:/Users/Thuy Duong/PycharmProjects/pythonProject2/datasets/w2v/20news-test-encoded.txt',
        batch_size=50
    )
    step = 0
    MAX_STEP = 10000
